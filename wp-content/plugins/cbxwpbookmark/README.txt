...
* [new] Setting class improved

= 1.7.18 =
* [fixed] Translation fixed

= 1.7.17 =
* [fixed] Pro addon compatibility fixed for template loading function wrong

= 1.7.16 =
* [fixed] Pro addon compatibility fixed

= 1.7.15 =
* [fixed] Pro addon compatibility fixed

= 1.7.14 =
* [added] Show/hide bookmark button for guest user
* [new] PHP 8.x compatibility checked
* [new] New Dashboard

= 1.7.13 =
* [fixed] Added new option to disable login form in modal
* [updated] Gutenberg Blocks are updated to make compatible with latest WordPress
* [updated] Pro addon updated

= 1.7.12 =
* [fixed] Share url now support category filter
* [updated] Restructured block, widgets, elementor widget etc folders and updated code
* [updated] Pro addon updated

= 1.7.11 =
* [new] Customizer Updated for share option

= 1.7.10 =
* [new] Added share my bookmark page
* [updated] Style improved
* [updated] Elementor compatibility checked
* [updated] Translation updated

= 1.7.9 =
* [new] Awesome notification translation added

= 1.7.8 =
* [new] Added awesome notification style confirm dialog and success/error notification
* [updated] Few style improvement for better theme compatibility

= 1.7.7 =
* [fixed] Added support for php version less than php7
