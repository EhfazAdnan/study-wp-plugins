                ...
                <div class="cbx-backend-card dashboard-changelog">
                    ...
                    <div class="content">
                        <div class="cbx-backend-settings-row">
                            ...
                            <ul>
                                <li>[fixed] Translation fixed</li>
                                <li>[updated] Pro addon new version released</li>
                                <li>[new] Setting class improved</li>
                            </ul>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <p>
                        ...
                        <div class="cbx-backend-settings-row">
                            ...
                            <ul>
                                <li>[fixed] Pro addon compatibility fixed for template loading function wrong</li>
                            </ul>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <p>
                            ...
                            <ul>
                                <li>[fixed] Pro addon compatibility fixed 2nd attempt</li>
                            </ul>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <p>
                            ...
                            <ul>
                                <li>[fixed] Pro addon compatibility fixed</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="cbx-backend-card dashboard-changelog">
                    ...
                    <div class="content">
                        <div class="cbx-backend-settings-row">
                            ...
                            <ul>
                                <li>[new] Post type specific thumbnail size</li>
                            </ul>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <p>
                            ...
                            <ul>
                                <li>[fixed] Pro addon template loading function wrong</li>
                            </ul>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <p>
                            ...
                            <ul>
                                <li>[fixed] Woocommerce related widget fixed 2nd attempt</li>
                            </ul>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <p>
                            ...
                            <ul>
                                <li>[fixed] Woocommerce related widget fixed</li>
                            </ul>
                        </div>
                    </div>
                </div>
